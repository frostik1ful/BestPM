...
<form:form method="post" modelAttribute="userForm" class="form-signin"
	...
	<h2 class="form-signin-heading" style="text-align: center;">Обновление профиля</h2>
	<spring:bind path="username">
		<div style="visibility: hidden" class="form-group ${status.error ? 'has-error' : ''}">
	...
	<button class="btn btn-lg btn-primary btn-block" type="submit">Обновить данные</button>
